                        ...
                        <div class="dramic_94">
                            <div class="preson_90">
                                <div class="dramic_89 border" id="present_1" @click="sel_pre_top(1)">
                                    <div class="dramic_93">
                                        <img class="dramic_91" src="<?=base_url()?>plusone88/assets/img/icon-money@2x.png" alt="">
                                    </div>
                                    <div class="dramic_92">
                                        1 P幣
                                    </div>
                        ...
                        <div class="dramic_94">
                            <div class="dramic_95">
                                <div class="dramic_89 border_bot" id="present_9" @click="sel_pre_bot(9)">
                                    <div class="dramic_93">
                                        <img class="dramic_91" src="<?=base_url()?>plusone88/assets/img/icon-greenbean@2x.png" alt="">
                                    </div>
                                    <div class="dramic_92">
                                        1 P幣
                                    </div>
        ...
        <div class="person_27">
            <div class="person_28">
                ...
                <div class="person_34">
                    ...
                    <a href="<?=base_url('plusone/person/')?><?=$value['id']?>"><div class="person_29" @click="addactive(-<?=$value['id']?>)" id="person_-<?=$value['id']?>"><?=$skill_type[$value['skill_type']]['skill_name']?></div></a>
                    <?endforeach;?>
                    <!--div class="person_35">
