    ...
    <div class="dialoag_1">
        <div class="dialoag_2">
            <div class="dramic_1">
                ...
                <!-- <div class="dialoag_4" @click="toggleswitch(3)">
                    系統通知
                </div> -->
            </div>
            <!-- 極速約單 -->
            <div class="dialoag_3" v-show="dialoagswitch == 1">
                <div class="dialoag_5">
                    <div class="dialoag_6 alldialoag" :id="'per_dialoag_'+id" @click="clikcperson(id,user.uid)" v-for="(user,id) in client_list">
                        <div class="dialoag_7">
                ...
                <div class="dialoag_15">
                    <div class="dialoag_16">
                        <div class="dialoag_33" style="height: 500px;">
                            <div class="dialoag_27" v-for="(list,i) in mutidialoag" v-show="list.overtime != `NaN : NaN`">
                                <div style="display: flex;cursor:pointer;" @click="clikcperson(-1,list.uid)">
                                    <div class="dialoag_28">
                                        <img class="dialoag_8" :src="list.src" alt="">
                                    </div>
                                    <div style="margin-top: 5px;">{{ list.name }}</div>
                                </div>
                                <div class="dialoag_32" style="margin-left: 45px;margin-top: -10px;">
                                    <div class="dialoag_29" v-html="list.content"></div>
                                    <div class="dialoag_30">倒數計時 <span class="dialoag_31">{{ list.overtime }}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <!-- 約單 -->
            <div class="dialoag_3" v-show="dialoagswitch == 2">
                <div class="dialoag_5">
                    <div class="dialoag_6 datealldialoag" :id="'date_dialoag_'+list.uid" @click="clikcdateperson(list.uid)" v-for="list in privatlist">
                        <div class="dialoag_7">
                            <img class="dialoag_8" :src="list.img" alt="">
                            <div id="avatar-wrap_div_status" class="dia_status_color"></div>
                        </div>
                        <div class="dialoag_9">
                            <div class="dialoag_10">
                                <div class="dialoag_11">{{ list.name }}</div>
                                <div class="dialoag_12"><img class="dialoag_13" :src="list.tag" alt=""></div>
                            </div>
                            <div class="dialoag_14">
                                {{ list.lastmessage }}
                            </div>
                            <div class="dialoag_49">
                                2
                            </div>
                        </div>
                        <div class="dialoag_45" @click.stop="addblock(list.uid)">
                            <span class="dialoag_46"></span>
                            <span class="dialoag_46"></span>
                            <span class="dialoag_46"></span>
                            <div class="dialoag_47" v-show="dialoag_block == list.uid">
                                <div class="dialoag_48 triangle">刪除</div>
                                <div class="dialoag_48">檢舉</div>
                                <div class="dialoag_48">封鎖</div>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="dialoag_15">
                    <div class="dialoag_16">
                        <div class="dialoag_17">
                            <div class="dialoag_18">{{ privatechat.name }}</div>
                            <div class="dialoag_19">{{ privatechat.time }}</div>
                        </div>
                        <div class="dialoag_33">
                            <template v-for="list in privatechat.dialoag">
                                <div class="dialoag_27steal" v-if="list.reply == 0">
                                    <div class="dialoag_28"><img class="dialoag_8" :src="list.img" alt=""></div>
                                    <div class="dialoag_32">
                                        <div class="dialoag_29">{{ list.message }}</div>
                                        <div class="dialoag_30" style="color: #878787;">{{ list.time }}</div>
                                    </div>
                                </div>
                                <div class="dialoag_27steal" style="flex-direction: row-reverse;" v-if="list.reply == 1">
                                    <div class="dialoag_28"><img class="dialoag_8" :src="list.img" alt=""></div>
                                    <div class="dialoag_32" style="flex-direction: row-reverse;">
                                        <div class="dialoag_29">{{ list.message }}</div>
                                        <div class="dialoag_30" style="color: #878787;">{{ list.time }}</div>
                                    </div>
                                </div>
                        ...
                        <div class="dialoag_34">
                            <hr class="dialoag_35">
                        </div>
                        <div class="dialoag_36">
                            <div class="dialoag_37" @click="diauploadimg()">
                                <img class="dialoag_38" src="/plusone88/assets/img/icon-uploadphoto@2x.png" alt="">
                            </div>
                            <input type="file" id="imagedia" class="imagedia" name="imagedia" style="display:none" @change="chandiaupimg">
                            <div class="dialoag_37 specialGiftdate">
                                <img class="dialoag_38" @click.stop="openbigpre()" src="/plusone88/assets/img/Group 120@2x.png" alt="">
                                <div class="dialoag_44" v-show="bigprepop == 1">
            ...
            <!-- 系統通知 -->
            <!-- <div class="dialoag_3" v-show="dialoagswitch == 3">
                <div class="dialoag_5">
                    <div class="dialoag_6 datealldialoag" id="date_dialoag_1" @click="clikcdateperson(1)">
                        <div class="dialoag_7">
                            <img class="dialoag_8" src="/plusone88/assets/img/logo@2x.png" alt="">
                        </div>
                        <div class="dialoag_9">
                            <div class="dialoag_10">
                                <div class="dialoag_11">官方通知</div>
                            </div>
                            <div class="dialoag_14">
                                嗨，系統將於今日將維修到...
                            </div>
                    ...
                    <div class="dialoag_6 datealldialoag" id="date_dialoag_2" @click="clikcdateperson(2)">
                        <div class="dialoag_7">
                            <img class="dialoag_8" src="/plusone88/assets/img/icon-newuser@2x.png" alt="">
                        </div>
                        <div class="dialoag_9">
                            <div class="dialoag_10">
                                <div class="dialoag_11">新用戶通知</div>
                            </div>
                            <div class="dialoag_14">
                                嗨，新會員Sheen...
                            </div>
                ...
                <div class="dialoag_15">
                    <div class="dialoag_16">
                        <div class="dialoag_33">
                            <div class="dialoag_27">
                                <div class="dialoag_28"><img class="dialoag_8" src="/plusone88/assets/img/img-profile@2x.png" alt=""></div>
                                <div class="dialoag_51">
                                    <div class="dialoag_53">嗨，新會員Sheena加入，跟她/他打個招呼吧～</div>
                                    <div class="dialoag_52">
                                        <div class="dialoag_50">打招呼</div>
